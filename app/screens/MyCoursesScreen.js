...
const MyCoursesScreen = () => {
    const [getMyCourses, setMyCourse] = useState([
        { id: 1, title: "دوره جامع NodeJs", master: "حسین اسدی" },
        { id: 2, title: "دوره جامع React Native", master: "حسین اسدی" },
        { id: 3, title: "دوره جامع ReactJs", master: "حسین اسدی" },
        { id: 4, title: "دوره جامع ElectronJs", master: "حسین اسدی" },
        { id: 5, title: "دوره جامع جاوااسکریپت", master: "حسین اسدی" },
    ]);
